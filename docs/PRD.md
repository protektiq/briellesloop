...
**FR-3.** When the user starts a session, the app loads 5–8 items from the chosen skill's queue, ordered by spaced-repetition priority (see §4.3) and **curated by the Content Agent** (see §11.2).
